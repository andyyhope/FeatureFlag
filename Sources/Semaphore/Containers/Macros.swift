...
/// describing its shape. That last one is why Semaphore needs no runtime reflection —
...
public macro FlagContainer() =
    #externalMacro(module: "SemaphoreMacros", type: "FlagContainerMacro")
...
public macro FlagGroup(description: String) =
    #externalMacro(module: "SemaphoreMacros", type: "FlagGroupMacro")
